...
// CREATE TABLE ( ... ) -------------------------------------------------------
  final public CreateTableCommand CreateTable() throws ParseException {
        String table;
        List<AttributeDecl> attributes = new ArrayList<AttributeDecl>();
        List<String> primaryKey = new ArrayList<String>();
        Map<String, AttributeDecl> foreignKeys = new HashMap<String, AttributeDecl>();
    ...
    while (true) {
      ...
      jj_consume_token(50);
                          foreignKeys.put(name, new AttributeDecl(token, foreignTable, foreignName));
    }
    jj_consume_token(50);
  ...
  final public AttributeDecl AttrDecl() throws ParseException {
        String name;
        AttributeDecl.Type type;
        int length;
        Exp constraint = null;
    jj_consume_token(IDENTIFIER);
                           name = token.image;
    ...
    case KW_CHAR:
      ...
      jj_consume_token(50);
                          type = AttributeDecl.Type.CHAR;
      break;
    case KW_DECIMAL:
      jj_consume_token(KW_DECIMAL);
                                         type = AttributeDecl.Type.DECIMAL;
      break;
    default:
      jj_la1[4] = jj_gen;
      jj_consume_token(-1);
    ...
    default:
      ...
      ;
          ...
          {if (true) return new AttributeDecl(token, null, type, name, constraint);}
    throw new Error("Missing return statement in function");
  }
...
// UPDATE table SET attr1=val1, ... WHERE conditions --------------------------
  final public UpdateCommand Update() throws ParseException {
        String table;
        List<AssignExp > assignments = new ArrayList<AssignExp>();
        Exp conditions;
  ...
  final public AssignExp AssignExpr() throws ParseException {
        AttributeExp target;
        Exp value;
    jj_consume_token(IDENTIFIER);
    ...
    value = Expression();
          {if (true) return new AssignExp(token, target, value);}
    throw new Error("Missing return statement in function");
  }
...
// +PrimaryExp, -PrimaryExp
  ...
  final public Exp PrimaryExp() throws ParseException {
    ...
    case STRING_LITERAL:
      jj_consume_token(STRING_LITERAL);
                          ret = new StringLiteralExp(token, token.image);
      break;
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000000,0x4b250400,0x0,0x0,0x80000000,0x800,0x0,0x0,0x0,0x0,0x0,0x3250400,0x300,0x300,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x20000,0x20000,0x3,0x0,0x20000,0x1010,0x20000,0x20000,0x20000,0x0,0x0,0x0,0xfc0,0xfc0,0xc,0xc,0x30,0x30,0xc,0x1700c,0x17000,};
   }
